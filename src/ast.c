...
{
	if (payload) {
		if (((struct payload *)(payload))->type == N_DECLARATION
		    && ((struct payload *)(payload))->alternative ==
		    ALT_EXPRESSION) {
			free((char *)(((struct payload *)(payload))->
				      declaration.identifier));
		}

		if (((struct payload *)(payload))->type == N_ATOMIC
		    && ((struct payload *)(payload))->alternative ==
		    ALT_IDENTIFIER) {
			free((char *)(((struct payload *)(payload))->atomic.
				      identifier));
		}
